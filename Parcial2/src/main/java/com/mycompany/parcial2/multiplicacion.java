...
public class multiplicacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet multiplicacion</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet multiplicacion at " + request.getContextPath() + "</h1>");
            ...
            out.println("\n<h3>El resultado de la multiplicacion es de: " + mult+"</h3>");
